        ...
        <div class="card card-signin my-5">
            <div class="card-body">
                ...
                <form class="form-signin" action="register" method="POST" id="loginForm" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label for="photoUri">Photo</label>
                        <input type="text" placeholder="Photo Uri" class="form-control" name="photoUri" id="photoUri" autocapitalize="none"/>
                    </div>
